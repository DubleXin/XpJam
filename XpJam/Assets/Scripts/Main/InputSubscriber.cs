...
public class InputSubscriber : MonoBehaviour
{
    ...
    {
        #region Movement
        _inputHandler.Player.Movement.performed += _ => _playerMovement.Direction = new Vector2(_playerMovement.Direction.x, _playerMovement.Direction.y);
        _inputHandler.Player.Movement.canceled += _ => _playerMovement.Direction = new Vector2(_playerMovement.Direction.x, _playerMovement.Direction.y);
        #endregion
    }
